...
class NuScenes3DDataset(Dataset):
    ...
    def get_data_info(self, index):
        ...
        if self.modality["use_camera"]:
            ...
            for cam_type, cam_info in info["cams"].items():
                ...
                for filename in image_paths:
                    if self.test_mode:
                        # new_filename = filename.replace('samples', 'images_orig')
        ...
        # forward_input_dict = self.driving_forward.__getitem__(info["token"], index)
        ...
        # dict_keys(['token', 'map_location', 'pts_filename', 'sweeps', 'timestamp', 'lidar2ego_translation', 'lidar2ego_rotation', 'ego2global_translation', 'ego2global_rotation', 'ego_status', 'map_infos', 
        # 'lidar2global', 'map_geoms', 'img_filename', 'lidar2img', 'lidar2cam', 'cam_intrinsic', 'gt_bboxes_3d', 'gt_labels_3d', 'gt_names', 'instance_inds', 'gt_agent_fut_trajs', 'gt_agent_fut_masks', 'gt_ego_fut_trajs', 'gt_ego_fut_masks', 'gt_ego_fut_cmd', 'fut_boxes'])
        
        # import pdb; pdb.set_trace()
        
        # input_dict['forward_ref'] = forward_input_dict
