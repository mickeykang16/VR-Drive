...
class GroupInBatchSampler(Sampler):
    ...
    def __init__(
        ...
        # print("rank: ", rank, "flag: ", self.flag)
        # print("rank: ", rank, "group_sizes: ", self.group_sizes)
        # print("rank: ", rank, "group_num: ",self.groups_num)
        # # print("===========")
        # print("rank: ", rank, "global_batch_size: ",self.global_batch_size)
        # print("rank: ", rank, "batch_size: ",batch_size)
