...
from .motion_utils import MotionBox, load_prediction, load_gt_custom, accumulate
...
class MotionEval:
    ...
    def __init__(self,
        ...
        self.gt_boxes = load_gt_custom(self.nusc, self.eval_set, sample_tokens, MotionBox, verbose=verbose, seconds=seconds)
