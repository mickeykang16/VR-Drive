...
def custom_multi_gpu_test(model, data_loader, tmpdir=None, gpu_collect=False):
    ...
    for i, data in enumerate(data_loader):
        with torch.no_grad():
            ...
            result, gaussian_result = model(return_loss=False, rescale=True, **data)
            
            psnr, ssim = gaussian_result
    ...
    print(f"avg PSNR: {avg_reconstruction_metric['psnr']/count:.4f}, avg SSIM: {avg_reconstruction_metric['ssim']/count:.4f}")
